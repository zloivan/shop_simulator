...
namespace Sim
{
    public class FPSController : MonoBehaviour
    {
        ...
        [SerializeField] private bool showInteractionRays = true; // Включение/выключение Gizmos
        [SerializeField] private Color primaryRayColor = Color.blue;
        [SerializeField] private Color secondaryRayColor = Color.red;
        ...
        {
            if (Physics.Raycast(interactionRayOrigin.position, interactionRayOrigin.forward, out var hit,
                    interactionDistance, interactionLayer))
            {
                if (hit.collider.TryGetComponent<IInteractable>(out var interactable))
                {
        ...
        {
            if (!showInteractionRays || interactionRayOrigin == null) return;

            Gizmos.color = primaryRayColor;
            Gizmos.DrawRay(interactionRayOrigin.position, interactionRayOrigin.forward * interactionDistance);
